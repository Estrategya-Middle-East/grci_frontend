...
@Component({
  selector: "app-control-nature-popup",
  standalone: true,
  imports: [ReactiveFormsModule, InputTextModule, ButtonModule],
  templateUrl: "./control-nature-popup.html",
  styleUrl: "./control-nature-popup.scss",
})
export class ControlNaturePopup implements OnInit {
