...
@Component({
  selector: "app-control-significance-popup",
  standalone: true,
  imports: [ReactiveFormsModule, InputTextModule, ButtonModule],
  templateUrl: "./control-significance-popup.html",
  styleUrl: "./control-significance-popup.scss",
})
export class ControlSignificancePopup implements OnInit {
