...
@Component({
  selector: "app-resources-functions-popup",
  standalone: true,
  imports: [ReactiveFormsModule, InputTextModule, ButtonModule],
  templateUrl: "./resources-functions-popup.html",
  styleUrl: "./resources-functions-popup.scss",
})
export class ResourcesFunctionsPopup implements OnInit {
