...
@Component({
  selector: 'app-audti-frequancies-toolbar',
  imports: [],
  providers:[DialogService],
  templateUrl: './audti-frequancies-toolbar.html',
  styleUrl: './audti-frequancies-toolbar.scss'
})
export class AudtiFrequanciesToolbar implements OnInit {
